...
%Read data: 
Ta = readtable("Exp2a1.csv").mc50; % container A, MC:50 
Tb = readtable("Exp2a1.csv").mc60; % container B, MC:60
Tc = readtable("Exp2a1.csv").mc70; % container C, MC:70
Tfb = readtable("Exp2b1.csv").bot; % temp bottom 
Tfm = readtable("Exp2b1.csv").mid; % temp mid
Tft = readtable("Exp2b1.csv").top; % temp top
Thb = readtable("Exp2c1.csv").bot; % temp bottom 
Thm = readtable("Exp2c1.csv").mid; % temp mid
Tht = readtable("Exp2c1.csv").top; % temp top
hr = linspace(0,1,97);
