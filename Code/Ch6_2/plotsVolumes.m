...
subplot(2,2,1);
plot(hr,curves(:,1),'k-',hr,T1a,':',hr,T1b,'-.',hr,T1c,'--','LineWidth',2.8)
ylim([20 70])
yticks(20:5:70)
grid on
ax = gca;
ax.FontSize = fs; 
legend('Model','CN25','CN30','CN35','fontsize',fs)
...
subplot(2,2,2);
plot(hr,curves(:,2),'k-',hr,T2a,':',hr,T2b,'-.',hr,T2c,'--','LineWidth',2.8)
ylim([20 70])
yticks(20:5:70)
grid on
ax = gca;
ax.FontSize = fs; 
legend('Model','MC50','MC60','MC70','fontsize',fs)
xlabel('Time (days)','fontsize',fs)
ylabel('Temperature (°C)','fontsize',fs)
title("(b)",'fontsize',fs)
fontname(f,'times')
...
subplot(2,2,3);
plot(hr,curves(:,3),'k-',hr,Tft,':',hr,Tfm,'-.',hr,Tfb,'--','LineWidth',2.8)
ylim([20 70])
yticks(20:5:70)
grid on
ax = gca;
ax.FontSize = fs; 
legend('Model','Top','Mid','Bottom','fontsize',fs)
xlabel('Time (days)','fontsize',fs)
ylabel('Temperature (°C)','fontsize',fs)
title("(c)",'fontsize',fs)
fontname(f,'times')
...
subplot(2,2,4);
plot(hr,curves(:,4),'k-',hr,Tht,':',hr,Thm,'-.',hr,Thb,'--','LineWidth',2.8)
ylim([20 70])
yticks(20:5:70)
grid on
ax = gca;
